namespace Mappy.Models
{
    ...
    public interface IMapModel
    {
        ...
        /// <returns>The feature instance with the given ID, or null if it is not found.</returns>
        FeatureInstance GetFeatureInstance(Guid id);

        /// <param name="x">The x coordinate.</param>
        /// <param name="y">The y coordinate.</param>
        /// <returns>True if the model contains a feature instance
        /// at the specified location.</returns>
        bool HasFeatureInstanceAt(int x, int y);

        /// <param name="x">The x coordinate.</param>
        /// <param name="y">The y coordinate.</param>
        /// <returns>The feature instance at the given location,
        /// or null if there is no feature instance at the location.</returns>
